...
$.fn.sKongHeadSelect = function (option) {
    ...
    $(option.eleL, option.eleR).on("click", function () {
        $(option.eleShowL, option.eleShowR).fadeIn(200).append(html).siblings(".wxc-alert-dg").fadeOut(200).find(".wxc-mask").remove();
    });
